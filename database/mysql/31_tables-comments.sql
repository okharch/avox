...
COMMENT ON TABLE clients_log is 'Logging changes on clients table';
...
COMMENT ON TABLE currency_rate is 'Historical records on exchange rate for each operational day';
COMMENT ON TABLE currency is 'List of currencies and their codes';
COMMENT ON TABLE msg_type IS 'Message codes';
COMMENT ON TABLE problem_status IS 'Reference for status of problem problem_status_id';
COMMENT ON TABLE problem_type IS 'Reference on problem type: warning/critical/fatal/etc';
COMMENT ON TABLE problems IS 'Records on Problems';
COMMENT ON TABLE problems_log IS 'Logging in problem resolution workflow';
COMMENT ON TABLE service_status IS 'Reference on service status: created/active/blocked/closed';
COMMENT ON TABLE service_type IS 'Reference on category of service with regard whether it is paid';
COMMENT ON TABLE services IS 'Records on services';
COMMENT ON TABLE services_log IS 'Logging of changes on services';
COMMENT ON TABLE services_tariff IS 'Tariff of services';
COMMENT ON TABLE services_tariff_log IS 'Logging of changes on services tariff';
