...
CREATE TABLE contracts (
  ...
  percent_limit double(10,2), -- 2.2 максимальный процент от суммы клиента для услуг
  amount_limit double(10,2), -- 10.2 максимальная сумма для услуг

  discount double(10,2), -- 10.2 сумма скидки
  percent_discount double(10,2) -- 2.2 %% скидки
);
